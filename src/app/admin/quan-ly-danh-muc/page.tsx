...
export default function AdminCategoryPage() {
  ...
  // Fetch categories
  useEffect(() => {
    if (user && accessChecked && hasRole("admin")) {
  ...
  }, [user, activeTab, accessChecked, hasRole]);
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      {user && accessChecked && isAuthenticated && hasRole("admin") && (
        <>
          <AdminSidebar />
                          ...
                          newsCategories.map((category, index) => (
                            ...
                            >
                              ...
                              <td className="px-6 py-4 whitespace-nowrap">
                                <button
                                  onClick={() =>
                                    handleToggleNewsActive(category)
                                  }
                                  className={`flex items-center space-x-1 px-2 py-1 text-xs font-medium rounded-full transition-all duration-200 ${
                                    category.isActive
                                      ? "bg-green-100 text-green-800 hover:bg-green-200"
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  setNewsCategoryFormData((prev) => ({
                                    ...prev,
                                    name,
                                    slug: newsCategoryService.generateSlug(
                                      name
                                    ),
                                  }));
                                }}
