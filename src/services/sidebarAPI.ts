...
export class SidebarAPI {
  ...
  static async getSidebarConfig(): Promise<SidebarAPIResponse> {
    try {
      ...
      showErrorToast("Lỗi khi tải cấu hình sidebar");
      return {
        success: false,
        data: {
          _id: "",
  ...
  static async getAllConfigs(): Promise<ConfigListResponse> {
    try {
      ...
      showErrorToast("Lỗi khi tải danh sách cấu hình");
      return {
        success: false,
        data: [],
  ...
  static async createConfig(
    ...
    try {
      ...
      showErrorToast("Lỗi khi tạo cấu hình");
      return {
        success: false,
        data: {
          _id: "",
  ...
  static async updateConfig(
    ...
    try {
      ...
      showErrorToast("Lỗi khi cập nhật cấu hình");
      return {
        success: false,
        data: {
          _id: "",
  ...
  static async deleteConfig(id: string): Promise<SidebarAPIResponse<boolean>> {
    try {
      ...
      showErrorToast("Lỗi khi xóa cấu hình");
      return {
        success: false,
        data: false,
  ...
  static async setDefaultConfig(id: string): Promise<SidebarAPIResponse> {
    try {
      ...
      showErrorToast("Lỗi khi đặt cấu hình mặc định");
      return {
        success: false,
        data: {
          _id: "",
  ...
  static async reorderItems(
    ...
    try {
      ...
      showErrorToast("Lỗi khi sắp xếp menu");
      return {
        success: false,
        data: {
          _id: "",
  ...
  static async addMenuItem(
    ...
    try {
      ...
      showErrorToast("Lỗi khi thêm menu item");
      return {
        success: false,
        data: {
          _id: "",
  ...
  static async removeMenuItem(
    ...
    try {
      ...
      showErrorToast("Lỗi khi xóa menu item");
      return {
        success: false,
        data: {
          _id: "",
